...
const contactLinks = [
  {
    label: 'Email',
    value: 'wicakbotak99@gmail.com',
    href: 'mailto:wicakbotak99@gmail.com',
  ...
  {
    label: 'LinkedIn',
    value: 'linkedin.com/in/andhika-wicaksono-aw',
    href: 'https://www.linkedin.com/in/andhika-wicaksono-aw/',
  ...
  {
    label: 'GitHub',
    value: 'github.com/dhikabotak99',
    href: 'https://github.com/dhikabotak99',
  ...
  },
  {
    ...
    href: 'https://wa.me/6281297747294',
  ...
  <section id="contact" class="relative py-24 lg:py-32">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="text-center mb-16 reveal">
        <span class="text-accent text-sm font-semibold tracking-widest uppercase">Get In Touch</span>
      ...
      <div class="max-w-4xl mx-auto grid sm:grid-cols-2 gap-4 reveal">
        <a
          ...
          class="glass rounded-xl p-6 flex items-center gap-5 glass-hover group hover:translate-y-[-4px] transition-all duration-300"
        >
          <div
          ...
          ></div>
          <div>
            <p class="text-xs text-muted font-medium">{{ link.label }}</p>
            <p class="text-white text-sm font-semibold group-hover:text-accent transition-colors duration-300">{{ link.value }}</p>
          </div>
        </a>
      </div>
    </div>
